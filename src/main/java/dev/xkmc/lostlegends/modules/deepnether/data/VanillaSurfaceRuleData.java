...
public class VanillaSurfaceRuleData {
    ...
    public static SurfaceRules.RuleSource overworldLike(boolean p_198381_, boolean p_198382_, boolean p_198383_) {
        ...
        SurfaceRules.ConditionSource dry = SurfaceRules.waterBlockCheck(0, 0);
        ...
        SurfaceRules.RuleSource surfacerules$rulesource = SurfaceRules.sequence(SurfaceRules.ifTrue(dry, GRASS_BLOCK), DIRT);
        ...
        SurfaceRules.RuleSource powderSnow0 = SurfaceRules.ifTrue(
            SurfaceRules.noiseCondition(Noises.POWDER_SNOW, 0.45, 0.58), SurfaceRules.ifTrue(dry, POWDER_SNOW)
        );
        SurfaceRules.RuleSource powderSnow1 = SurfaceRules.ifTrue(
            SurfaceRules.noiseCondition(Noises.POWDER_SNOW, 0.35, 0.6), SurfaceRules.ifTrue(dry, POWDER_SNOW)
        );
        SurfaceRules.RuleSource surfacerules$rulesource6 = SurfaceRules.sequence(
            SurfaceRules.ifTrue(
                ...
                SurfaceRules.sequence(
                    ...
                    SurfaceRules.ifTrue(dry, SNOW_BLOCK)
                )
            ),
            SurfaceRules.ifTrue(
            ...
            SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.GROVE), SurfaceRules.sequence(powderSnow0, DIRT)),
        ...
        SurfaceRules.RuleSource surfacerules$rulesource7 = SurfaceRules.sequence(
            ...
            SurfaceRules.ifTrue(
                ...
                SurfaceRules.sequence(
                    SurfaceRules.ifTrue(steep, STONE), SurfaceRules.ifTrue(dry, SNOW_BLOCK)
                )
            ),
            SurfaceRules.ifTrue(
                SurfaceRules.isBiome(Biomes.GROVE),
                SurfaceRules.sequence(powderSnow1, SurfaceRules.ifTrue(dry, SNOW_BLOCK))
            ),
            surfacerules$rulesource3,
            SurfaceRules.ifTrue(
            ...
            SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.ICE_SPIKES), SurfaceRules.ifTrue(dry, SNOW_BLOCK)),
            SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.MANGROVE_SWAMP), MUD),
                    ...
                    SurfaceRules.sequence(
                        SurfaceRules.ifTrue(
                            ...
                            SurfaceRules.ifTrue(
                                ...
                                SurfaceRules.sequence(
                                    SurfaceRules.ifTrue(dry, AIR), SurfaceRules.ifTrue(SurfaceRules.temperature(), ICE), WATER
                                )
                            )
                        ),
