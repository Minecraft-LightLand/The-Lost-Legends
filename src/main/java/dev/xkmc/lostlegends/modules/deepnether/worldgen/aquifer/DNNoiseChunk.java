...
public class DNNoiseChunk extends NoiseChunk {
	...
	public DNNoiseChunk(
			...
			Aquifer.FluidPicker aquifier, Blender blender,
			List<DNAquifer.BlockEntry> specialBlocks, List<DNAquifer.FluidEntry> specialFluids
	) {
		super(xz, rand, x0, z0, settings, marker, gen, aquifier, blender);
		aquifer = new DNAquifer(rand, gen.seaLevel(), gen.defaultFluid(), specialBlocks, specialFluids);
	}
