...
public class SimpleOnGroundFeature extends OnGroundFeature<SimpleOnGroundFeature.Data> {

	public SimpleOnGroundFeature() {
		super(Data.CODEC);
	}
	...
	public boolean place(FeaturePlaceContext<Data> ctx) {
		...
		if (pos == null)
			return false;
		var old = ctx.level().getBlockState(pos.below());
