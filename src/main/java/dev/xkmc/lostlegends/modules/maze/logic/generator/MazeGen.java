package dev.xkmc.lostlegends.modules.maze.logic.generator;
...
public class MazeGen {
	...
	class StateRim {
		...
		private void seg() {
			...
			if (r - 1 < config.invarianceRim.length && len() == config.invarianceRim[r - 1].length)
				rarr = config.invarianceRim[r - 1];
