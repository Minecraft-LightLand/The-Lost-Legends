...
public class PoisonBeholderSpell extends LLSpellGenEntry {
	...
	public static final ResourceLocation MODEL = LostLegends.loc("spell/poison_beholder_projectile");
	...
	private ConfiguredEngine<?> land(DataGenContext ctx) {
		return new ListLogic(List.of(
				BeholderUtils.explode(0xFF06C84D, 200, "0.3"),
				new SoundInstance(
						SoundEvents.DRAGON_FIREBALL_EXPLODE,
						DoubleVariable.of("2"),
						DoubleVariable.of("1+rand(-0.1,0.1)+rand(-0.1,0.1)")
				),
				BeholderUtils.affect("0.3",
						new EffectProcessor(MobEffects.POISON,
								IntVariable.of("(10-t)*25"),
