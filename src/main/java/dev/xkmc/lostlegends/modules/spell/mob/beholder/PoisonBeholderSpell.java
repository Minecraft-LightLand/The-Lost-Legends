...
public class PoisonBeholderSpell extends LLSpellGenEntry {

	public static final ResourceKey<SpellAction> SPELL = spell("poison_beholder_magic");
	public static final DataGenCachedHolder<ProjectileConfig> PROJ = projectile("poison_beholder_projectile");

	@Override
	public void genLang(RegistrateLangProvider pvd) {
		pvd.add(SpellAction.lang(SPELL.location()), "Poison Beholder Magic");
	}
	...
	private ProjectileConfig circularProjectile(DataGenContext ctx) {
		return ProjectileConfig.builder(SelectionType.ENEMY_NO_FAMILY)
				...
				.tick(new SimpleParticleInstance(ParticleTypes.COMPOSTER, DoubleVariable.ZERO))
				.land(land(ctx))
		...
		return new ListLogic(List.of(
				new LoopIterator(
						...
						new DustParticleInstance(
								ColorVariable.Static.of(0xFF06C84D),
				...
				new DelayedIterator(IntVariable.of("10"), IntVariable.of("1"),
						new ProcessorEngine(SelectionType.ENEMY_NO_FAMILY,
								new BoxSelector(
										DoubleVariable.of("(t+2)*0.3"),
										DoubleVariable.of("(t+2)*0.3"),
										true
								), List.of(
								new EffectProcessor(MobEffects.POISON, IntVariable.of("(10-t)*25"), IntVariable.of("0"), false, true)
						)), "t"
				)
		));
	}
